...
theorem panel14Mode18MatVecRange0 :
...
theorem panel14Mode18MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨9, by decide⟩).get row =
...
theorem panel14Mode18MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨9, by decide⟩).get row =
...
theorem panel14Mode18MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨9, by decide⟩).get row =
...
theorem panel14Mode18MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨9, by decide⟩).get row =
