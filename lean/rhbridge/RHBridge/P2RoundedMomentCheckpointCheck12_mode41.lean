...
theorem panel12Mode41MatVecRange0 :
...
theorem panel12Mode41MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel12Mode41MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel12Mode41MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel12Mode41MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
