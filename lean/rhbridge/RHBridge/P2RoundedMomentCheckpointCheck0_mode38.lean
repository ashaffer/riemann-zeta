...
theorem panel0Mode38MatVecRange0 :
...
theorem panel0Mode38MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
...
theorem panel0Mode38MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
...
theorem panel0Mode38MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
...
theorem panel0Mode38MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
