...
theorem panel8Mode42MatVecRange0 :
...
theorem panel8Mode42MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
...
theorem panel8Mode42MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
...
theorem panel8Mode42MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
...
theorem panel8Mode42MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
