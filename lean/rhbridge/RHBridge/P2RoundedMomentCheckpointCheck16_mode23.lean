...
theorem panel16Mode23MatVecRange0 :
...
theorem panel16Mode23MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
...
theorem panel16Mode23MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
...
theorem panel16Mode23MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
...
theorem panel16Mode23MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
