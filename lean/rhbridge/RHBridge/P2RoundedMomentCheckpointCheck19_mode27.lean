...
theorem panel19Mode27MatVecRange0 :
...
theorem panel19Mode27MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel19Mode27MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel19Mode27MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel19Mode27MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
