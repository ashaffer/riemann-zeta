...
theorem panel25Mode3MatVecRange0 :
...
theorem panel25Mode3MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
...
theorem panel25Mode3MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
...
theorem panel25Mode3MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
...
theorem panel25Mode3MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
