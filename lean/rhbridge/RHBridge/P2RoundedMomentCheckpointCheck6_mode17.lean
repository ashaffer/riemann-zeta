...
theorem panel6Mode17MatVecRange0 :
...
theorem panel6Mode17MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
...
theorem panel6Mode17MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
...
theorem panel6Mode17MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
...
theorem panel6Mode17MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
