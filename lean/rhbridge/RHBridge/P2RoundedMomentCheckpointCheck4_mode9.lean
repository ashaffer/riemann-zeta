...
theorem panel4Mode9MatVecRange0 :
...
theorem panel4Mode9MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
...
theorem panel4Mode9MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
...
theorem panel4Mode9MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
...
theorem panel4Mode9MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
