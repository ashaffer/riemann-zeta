...
theorem panel14Mode15MatVecRange0 :
...
theorem panel14Mode15MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel14Mode15MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel14Mode15MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel14Mode15MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
