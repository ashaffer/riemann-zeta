...
theorem panel12Mode39MatVecRange0 :
...
theorem panel12Mode39MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨19, by decide⟩).get row =
...
theorem panel12Mode39MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨19, by decide⟩).get row =
...
theorem panel12Mode39MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨19, by decide⟩).get row =
...
theorem panel12Mode39MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .odd ⟨19, by decide⟩).get row =
