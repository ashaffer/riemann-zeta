...
theorem panel25Mode43MatVecRange0 :
...
theorem panel25Mode43MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
...
theorem panel25Mode43MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
...
theorem panel25Mode43MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
...
theorem panel25Mode43MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
