...
theorem panel14Mode35MatVecRange0 :
...
theorem panel14Mode35MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel14Mode35MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel14Mode35MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel14Mode35MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
