...
theorem panel4Mode13MatVecRange0 :
...
theorem panel4Mode13MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨6, by decide⟩).get row =
...
theorem panel4Mode13MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨6, by decide⟩).get row =
...
theorem panel4Mode13MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨6, by decide⟩).get row =
...
theorem panel4Mode13MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨6, by decide⟩).get row =
