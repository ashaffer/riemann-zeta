...
theorem panel0Mode28MatVecRange0 :
...
theorem panel0Mode28MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
...
theorem panel0Mode28MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
...
theorem panel0Mode28MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
...
theorem panel0Mode28MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
