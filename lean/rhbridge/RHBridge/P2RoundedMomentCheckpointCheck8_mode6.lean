...
theorem panel8Mode6MatVecRange0 :
...
theorem panel8Mode6MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel8Mode6MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel8Mode6MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel8Mode6MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel8MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
