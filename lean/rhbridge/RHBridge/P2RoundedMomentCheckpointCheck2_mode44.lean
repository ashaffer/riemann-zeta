...
theorem panel2Mode44MatVecRange0 :
...
theorem panel2Mode44MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel2Mode44MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel2Mode44MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel2Mode44MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
