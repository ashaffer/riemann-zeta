...
theorem panel6Mode16MatVecRange0 :
...
theorem panel6Mode16MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
...
theorem panel6Mode16MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
...
theorem panel6Mode16MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
...
theorem panel6Mode16MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
