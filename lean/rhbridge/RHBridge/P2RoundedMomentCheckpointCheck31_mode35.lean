...
theorem panel31Mode35MatVecRange0 :
...
theorem panel31Mode35MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel31Mode35MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel31Mode35MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel31Mode35MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
