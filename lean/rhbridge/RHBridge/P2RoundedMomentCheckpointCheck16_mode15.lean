...
theorem panel16Mode15MatVecRange0 :
...
theorem panel16Mode15MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel16Mode15MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel16Mode15MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel16Mode15MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
