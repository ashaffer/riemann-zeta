...
theorem panel11Mode19MatVecRange0 :
...
theorem panel11Mode19MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
...
theorem panel11Mode19MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
...
theorem panel11Mode19MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
...
theorem panel11Mode19MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
