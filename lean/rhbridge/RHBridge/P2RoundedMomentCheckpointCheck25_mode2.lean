...
theorem panel25Mode2MatVecRange0 :
...
theorem panel25Mode2MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
...
theorem panel25Mode2MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
...
theorem panel25Mode2MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
...
theorem panel25Mode2MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel25MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
