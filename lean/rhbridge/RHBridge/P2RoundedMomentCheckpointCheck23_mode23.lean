...
theorem panel23Mode23MatVecRange0 :
...
theorem panel23Mode23MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
...
theorem panel23Mode23MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
...
theorem panel23Mode23MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
...
theorem panel23Mode23MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨11, by decide⟩).get row =
