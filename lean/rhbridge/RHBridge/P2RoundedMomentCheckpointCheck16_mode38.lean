...
theorem panel16Mode38MatVecRange0 :
...
theorem panel16Mode38MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
...
theorem panel16Mode38MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
...
theorem panel16Mode38MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
...
theorem panel16Mode38MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨19, by decide⟩).get row =
