...
theorem panel6Mode32MatVecRange0 :
...
theorem panel6Mode32MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨16, by decide⟩).get row =
...
theorem panel6Mode32MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨16, by decide⟩).get row =
...
theorem panel6Mode32MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨16, by decide⟩).get row =
...
theorem panel6Mode32MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .even ⟨16, by decide⟩).get row =
