...
theorem panel20Mode4MatVecRange0 :
...
theorem panel20Mode4MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel20Mode4MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel20Mode4MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel20Mode4MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
