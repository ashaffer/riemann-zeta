...
theorem panel15Mode19MatVecRange0 :
...
theorem panel15Mode19MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
...
theorem panel15Mode19MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
...
theorem panel15Mode19MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
...
theorem panel15Mode19MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨9, by decide⟩).get row =
