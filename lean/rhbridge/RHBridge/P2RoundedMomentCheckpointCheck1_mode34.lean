...
theorem panel1Mode34MatVecRange0 :
...
theorem panel1Mode34MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel1MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel1Mode34MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel1MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel1Mode34MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel1MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel1Mode34MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel1MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
