...
theorem panel13Mode6MatVecRange0 :
...
theorem panel13Mode6MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel13Mode6MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel13Mode6MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel13Mode6MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
