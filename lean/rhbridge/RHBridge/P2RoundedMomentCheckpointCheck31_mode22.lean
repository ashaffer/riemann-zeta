...
theorem panel31Mode22MatVecRange0 :
...
theorem panel31Mode22MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
...
theorem panel31Mode22MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
...
theorem panel31Mode22MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
...
theorem panel31Mode22MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
