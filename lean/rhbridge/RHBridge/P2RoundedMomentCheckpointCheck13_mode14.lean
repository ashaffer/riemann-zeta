...
theorem panel13Mode14MatVecRange0 :
...
theorem panel13Mode14MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨7, by decide⟩).get row =
...
theorem panel13Mode14MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨7, by decide⟩).get row =
...
theorem panel13Mode14MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨7, by decide⟩).get row =
...
theorem panel13Mode14MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .even ⟨7, by decide⟩).get row =
