...
theorem panel24Mode40MatVecRange0 :
...
theorem panel24Mode40MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel24Mode40MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel24Mode40MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel24Mode40MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
