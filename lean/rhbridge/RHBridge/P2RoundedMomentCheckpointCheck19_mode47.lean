...
theorem panel19Mode47MatVecRange0 :
...
theorem panel19Mode47MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
...
theorem panel19Mode47MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
...
theorem panel19Mode47MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
...
theorem panel19Mode47MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
