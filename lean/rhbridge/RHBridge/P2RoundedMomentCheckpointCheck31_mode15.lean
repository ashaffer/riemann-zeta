...
theorem panel31Mode15MatVecRange0 :
...
theorem panel31Mode15MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel31Mode15MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel31Mode15MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
...
theorem panel31Mode15MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨7, by decide⟩).get row =
