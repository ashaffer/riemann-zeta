...
theorem panel16Mode36MatVecRange0 :
...
theorem panel16Mode36MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel16Mode36MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel16Mode36MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel16Mode36MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel16MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
