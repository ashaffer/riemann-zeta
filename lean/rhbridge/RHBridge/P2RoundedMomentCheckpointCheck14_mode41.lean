...
theorem panel14Mode41MatVecRange0 :
...
theorem panel14Mode41MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel14Mode41MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel14Mode41MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel14Mode41MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
