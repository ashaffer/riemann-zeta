...
theorem panel14Mode34MatVecRange0 :
...
theorem panel14Mode34MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel14Mode34MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel14Mode34MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel14Mode34MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
