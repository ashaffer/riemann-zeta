...
theorem panel14Mode33MatVecRange0 :
...
theorem panel14Mode33MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
...
theorem panel14Mode33MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
...
theorem panel14Mode33MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
...
theorem panel14Mode33MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
