...
theorem panel19Mode9MatVecRange0 :
...
theorem panel19Mode9MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
...
theorem panel19Mode9MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
...
theorem panel19Mode9MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
...
theorem panel19Mode9MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨4, by decide⟩).get row =
