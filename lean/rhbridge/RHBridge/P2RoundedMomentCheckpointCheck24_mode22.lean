...
theorem panel24Mode22MatVecRange0 :
...
theorem panel24Mode22MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
...
theorem panel24Mode22MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
...
theorem panel24Mode22MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
...
theorem panel24Mode22MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨11, by decide⟩).get row =
