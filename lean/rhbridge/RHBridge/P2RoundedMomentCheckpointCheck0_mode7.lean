...
theorem panel0Mode7MatVecRange0 :
...
theorem panel0Mode7MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨3, by decide⟩).get row =
...
theorem panel0Mode7MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨3, by decide⟩).get row =
...
theorem panel0Mode7MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨3, by decide⟩).get row =
...
theorem panel0Mode7MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨3, by decide⟩).get row =
