...
theorem panel6Mode47MatVecRange0 :
...
theorem panel6Mode47MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
...
theorem panel6Mode47MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
...
theorem panel6Mode47MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
...
theorem panel6Mode47MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel6MomentData.matvecs
            .odd ⟨23, by decide⟩).get row =
