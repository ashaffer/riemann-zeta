...
theorem panel14Mode17MatVecRange0 :
...
theorem panel14Mode17MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
...
theorem panel14Mode17MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
...
theorem panel14Mode17MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
...
theorem panel14Mode17MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .odd ⟨8, by decide⟩).get row =
