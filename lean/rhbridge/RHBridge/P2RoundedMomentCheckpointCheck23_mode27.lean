...
theorem panel23Mode27MatVecRange0 :
...
theorem panel23Mode27MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel23Mode27MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel23Mode27MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel23Mode27MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel23MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
