...
theorem panel15Mode35MatVecRange0 :
...
theorem panel15Mode35MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel15Mode35MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel15Mode35MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
...
theorem panel15Mode35MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel15MomentData.matvecs
            .odd ⟨17, by decide⟩).get row =
