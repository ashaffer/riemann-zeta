...
theorem panel0Mode45MatVecRange0 :
...
theorem panel0Mode45MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨22, by decide⟩).get row =
...
theorem panel0Mode45MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨22, by decide⟩).get row =
...
theorem panel0Mode45MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨22, by decide⟩).get row =
...
theorem panel0Mode45MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨22, by decide⟩).get row =
