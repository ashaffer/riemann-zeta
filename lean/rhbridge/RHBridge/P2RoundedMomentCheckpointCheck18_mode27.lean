...
theorem panel18Mode27MatVecRange0 :
...
theorem panel18Mode27MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel18Mode27MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel18Mode27MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel18Mode27MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
