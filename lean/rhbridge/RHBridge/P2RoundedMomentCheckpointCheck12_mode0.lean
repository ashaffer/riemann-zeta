...
theorem panel12Mode0MatVecRange0 :
...
theorem panel12Mode0MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel12Mode0MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel12Mode0MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel12Mode0MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
