...
theorem panel26Mode0MatVecRange0 :
...
theorem panel26Mode0MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel26Mode0MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel26Mode0MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel26Mode0MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
