...
theorem panel28Mode26MatVecRange0 :
...
theorem panel28Mode26MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel28MomentData.matvecs
            .even ⟨13, by decide⟩).get row =
...
theorem panel28Mode26MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel28MomentData.matvecs
            .even ⟨13, by decide⟩).get row =
...
theorem panel28Mode26MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel28MomentData.matvecs
            .even ⟨13, by decide⟩).get row =
...
theorem panel28Mode26MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel28MomentData.matvecs
            .even ⟨13, by decide⟩).get row =
