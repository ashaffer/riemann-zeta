...
theorem panel2Mode16MatVecRange0 :
...
theorem panel2Mode16MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
...
theorem panel2Mode16MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
...
theorem panel2Mode16MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
...
theorem panel2Mode16MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨8, by decide⟩).get row =
