...
theorem panel0Mode40MatVecRange0 :
...
theorem panel0Mode40MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel0Mode40MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel0Mode40MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel0Mode40MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
