...
theorem panel18Mode34MatVecRange0 :
...
theorem panel18Mode34MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel18Mode34MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel18Mode34MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
...
theorem panel18Mode34MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨17, by decide⟩).get row =
