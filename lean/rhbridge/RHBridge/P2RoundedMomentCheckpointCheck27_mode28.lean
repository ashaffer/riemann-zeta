...
theorem panel27Mode28MatVecRange0 :
...
theorem panel27Mode28MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel27MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
...
theorem panel27Mode28MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel27MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
...
theorem panel27Mode28MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel27MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
...
theorem panel27Mode28MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel27MomentData.matvecs
            .even ⟨14, by decide⟩).get row =
