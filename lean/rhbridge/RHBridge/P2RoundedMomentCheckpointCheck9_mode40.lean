...
theorem panel9Mode40MatVecRange0 :
...
theorem panel9Mode40MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel9MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel9Mode40MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel9MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel9Mode40MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel9MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel9Mode40MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel9MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
