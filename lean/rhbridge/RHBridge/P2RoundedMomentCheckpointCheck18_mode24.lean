...
theorem panel18Mode24MatVecRange0 :
...
theorem panel18Mode24MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨12, by decide⟩).get row =
...
theorem panel18Mode24MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨12, by decide⟩).get row =
...
theorem panel18Mode24MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨12, by decide⟩).get row =
...
theorem panel18Mode24MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel18MomentData.matvecs
            .even ⟨12, by decide⟩).get row =
