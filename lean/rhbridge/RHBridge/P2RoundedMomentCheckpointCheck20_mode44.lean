...
theorem panel20Mode44MatVecRange0 :
...
theorem panel20Mode44MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel20Mode44MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel20Mode44MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel20Mode44MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
