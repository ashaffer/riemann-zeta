...
theorem panel31Mode43MatVecRange0 :
...
theorem panel31Mode43MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
...
theorem panel31Mode43MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
...
theorem panel31Mode43MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
...
theorem panel31Mode43MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel31MomentData.matvecs
            .odd ⟨21, by decide⟩).get row =
