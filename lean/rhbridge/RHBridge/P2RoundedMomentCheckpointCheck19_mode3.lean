...
theorem panel19Mode3MatVecRange0 :
...
theorem panel19Mode3MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
...
theorem panel19Mode3MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
...
theorem panel19Mode3MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
...
theorem panel19Mode3MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨1, by decide⟩).get row =
