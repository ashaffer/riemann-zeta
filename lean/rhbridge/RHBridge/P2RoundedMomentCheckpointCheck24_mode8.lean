...
theorem panel24Mode8MatVecRange0 :
...
theorem panel24Mode8MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨4, by decide⟩).get row =
...
theorem panel24Mode8MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨4, by decide⟩).get row =
...
theorem panel24Mode8MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨4, by decide⟩).get row =
...
theorem panel24Mode8MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel24MomentData.matvecs
            .even ⟨4, by decide⟩).get row =
