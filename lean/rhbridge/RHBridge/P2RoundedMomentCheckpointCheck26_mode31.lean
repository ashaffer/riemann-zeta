...
theorem panel26Mode31MatVecRange0 :
...
theorem panel26Mode31MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
...
theorem panel26Mode31MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
...
theorem panel26Mode31MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
...
theorem panel26Mode31MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
