...
theorem panel0Mode0MatVecRange0 :
...
theorem panel0Mode0MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel0Mode0MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel0Mode0MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
...
theorem panel0Mode0MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .even ⟨0, by decide⟩).get row =
