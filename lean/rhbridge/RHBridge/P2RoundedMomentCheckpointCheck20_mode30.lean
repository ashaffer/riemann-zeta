...
theorem panel20Mode30MatVecRange0 :
...
theorem panel20Mode30MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨15, by decide⟩).get row =
...
theorem panel20Mode30MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨15, by decide⟩).get row =
...
theorem panel20Mode30MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨15, by decide⟩).get row =
...
theorem panel20Mode30MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel20MomentData.matvecs
            .even ⟨15, by decide⟩).get row =
