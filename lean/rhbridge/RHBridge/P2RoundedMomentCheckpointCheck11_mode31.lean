...
theorem panel11Mode31MatVecRange0 :
...
theorem panel11Mode31MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
...
theorem panel11Mode31MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
...
theorem panel11Mode31MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
...
theorem panel11Mode31MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel11MomentData.matvecs
            .odd ⟨15, by decide⟩).get row =
