...
theorem panel19Mode1MatVecRange0 :
...
theorem panel19Mode1MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨0, by decide⟩).get row =
...
theorem panel19Mode1MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨0, by decide⟩).get row =
...
theorem panel19Mode1MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨0, by decide⟩).get row =
...
theorem panel19Mode1MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .odd ⟨0, by decide⟩).get row =
