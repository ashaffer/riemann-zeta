...
theorem panel7Mode21MatVecRange0 :
...
theorem panel7Mode21MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
...
theorem panel7Mode21MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
...
theorem panel7Mode21MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
...
theorem panel7Mode21MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
