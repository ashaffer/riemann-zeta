...
theorem panel5Mode36MatVecRange0 :
...
theorem panel5Mode36MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel5MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel5Mode36MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel5MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel5Mode36MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel5MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel5Mode36MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel5MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
