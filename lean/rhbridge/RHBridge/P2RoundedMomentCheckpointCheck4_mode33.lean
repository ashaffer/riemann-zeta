...
theorem panel4Mode33MatVecRange0 :
...
theorem panel4Mode33MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
...
theorem panel4Mode33MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
...
theorem panel4Mode33MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
...
theorem panel4Mode33MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .odd ⟨16, by decide⟩).get row =
