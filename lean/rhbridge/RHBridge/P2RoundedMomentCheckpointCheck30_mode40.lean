...
theorem panel30Mode40MatVecRange0 :
...
theorem panel30Mode40MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel30MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel30Mode40MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel30MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel30Mode40MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel30MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
...
theorem panel30Mode40MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel30MomentData.matvecs
            .even ⟨20, by decide⟩).get row =
