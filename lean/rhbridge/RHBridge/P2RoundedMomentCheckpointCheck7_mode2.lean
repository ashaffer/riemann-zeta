...
theorem panel7Mode2MatVecRange0 :
...
theorem panel7Mode2MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
...
theorem panel7Mode2MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
...
theorem panel7Mode2MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
...
theorem panel7Mode2MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .even ⟨1, by decide⟩).get row =
