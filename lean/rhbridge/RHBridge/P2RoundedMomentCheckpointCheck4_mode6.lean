...
theorem panel4Mode6MatVecRange0 :
...
theorem panel4Mode6MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel4Mode6MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel4Mode6MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel4Mode6MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
