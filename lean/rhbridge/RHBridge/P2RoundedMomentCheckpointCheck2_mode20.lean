...
theorem panel2Mode20MatVecRange0 :
...
theorem panel2Mode20MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
...
theorem panel2Mode20MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
...
theorem panel2Mode20MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
...
theorem panel2Mode20MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
