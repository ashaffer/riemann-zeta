...
theorem panel7Mode27MatVecRange0 :
...
theorem panel7Mode27MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel7Mode27MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel7Mode27MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
...
theorem panel7Mode27MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel7MomentData.matvecs
            .odd ⟨13, by decide⟩).get row =
