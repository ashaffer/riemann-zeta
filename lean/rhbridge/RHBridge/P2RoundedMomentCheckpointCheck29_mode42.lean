...
theorem panel29Mode42MatVecRange0 :
...
theorem panel29Mode42MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel29MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
...
theorem panel29Mode42MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel29MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
...
theorem panel29Mode42MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel29MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
...
theorem panel29Mode42MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel29MomentData.matvecs
            .even ⟨21, by decide⟩).get row =
