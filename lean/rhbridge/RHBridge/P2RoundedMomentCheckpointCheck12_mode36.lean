...
theorem panel12Mode36MatVecRange0 :
...
theorem panel12Mode36MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel12Mode36MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel12Mode36MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
...
theorem panel12Mode36MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨18, by decide⟩).get row =
