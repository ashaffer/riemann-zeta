...
theorem panel19Mode20MatVecRange0 :
...
theorem panel19Mode20MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
...
theorem panel19Mode20MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
...
theorem panel19Mode20MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
...
theorem panel19Mode20MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel19MomentData.matvecs
            .even ⟨10, by decide⟩).get row =
