...
theorem panel21Mode12MatVecRange0 :
...
theorem panel21Mode12MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
...
theorem panel21Mode12MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
...
theorem panel21Mode12MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
...
theorem panel21Mode12MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
