...
theorem panel13Mode29MatVecRange0 :
...
theorem panel13Mode29MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .odd ⟨14, by decide⟩).get row =
...
theorem panel13Mode29MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .odd ⟨14, by decide⟩).get row =
...
theorem panel13Mode29MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .odd ⟨14, by decide⟩).get row =
...
theorem panel13Mode29MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel13MomentData.matvecs
            .odd ⟨14, by decide⟩).get row =
