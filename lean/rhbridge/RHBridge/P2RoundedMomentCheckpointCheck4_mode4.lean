...
theorem panel4Mode4MatVecRange0 :
...
theorem panel4Mode4MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel4Mode4MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel4Mode4MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel4Mode4MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel4MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
