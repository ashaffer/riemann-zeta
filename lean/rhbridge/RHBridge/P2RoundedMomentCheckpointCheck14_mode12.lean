...
theorem panel14Mode12MatVecRange0 :
...
theorem panel14Mode12MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
...
theorem panel14Mode12MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
...
theorem panel14Mode12MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
...
theorem panel14Mode12MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel14MomentData.matvecs
            .even ⟨6, by decide⟩).get row =
