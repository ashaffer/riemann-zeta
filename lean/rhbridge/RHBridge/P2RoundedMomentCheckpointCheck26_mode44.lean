...
theorem panel26Mode44MatVecRange0 :
...
theorem panel26Mode44MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel26Mode44MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel26Mode44MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
...
theorem panel26Mode44MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel26MomentData.matvecs
            .even ⟨22, by decide⟩).get row =
