...
theorem panel12Mode4MatVecRange0 :
...
theorem panel12Mode4MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel12Mode4MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel12Mode4MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
...
theorem panel12Mode4MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel12MomentData.matvecs
            .even ⟨2, by decide⟩).get row =
