...
theorem panel0Mode41MatVecRange0 :
...
theorem panel0Mode41MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel0Mode41MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel0Mode41MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
...
theorem panel0Mode41MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨20, by decide⟩).get row =
