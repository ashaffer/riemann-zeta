...
theorem panel0Mode21MatVecRange0 :
...
theorem panel0Mode21MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
...
theorem panel0Mode21MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
...
theorem panel0Mode21MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
...
theorem panel0Mode21MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel0MomentData.matvecs
            .odd ⟨10, by decide⟩).get row =
