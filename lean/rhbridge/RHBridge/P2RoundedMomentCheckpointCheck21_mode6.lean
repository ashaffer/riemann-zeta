...
theorem panel21Mode6MatVecRange0 :
...
theorem panel21Mode6MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel21Mode6MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel21Mode6MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel21Mode6MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel21MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
