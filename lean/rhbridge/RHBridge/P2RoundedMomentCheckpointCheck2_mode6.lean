...
theorem panel2Mode6MatVecRange0 :
...
theorem panel2Mode6MatVecRange32 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel2Mode6MatVecRange64 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel2Mode6MatVecRange96 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
...
theorem panel2Mode6MatVecRange128 :
    P2RoundedGeneratedCertificate.FinRangeAll
      (fun row : Fin 149 =>
        (P2RoundedFactorCheckpointData.panel2MomentData.matvecs
            .even ⟨3, by decide⟩).get row =
